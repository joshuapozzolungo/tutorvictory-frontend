    ...
    <footer className="w-full min-h-120 flex flex-col justify-between border-t border-t-paragraph/20 bg-primary">
      ...
      <div className="flex flex-col sm:flex-row items-start gap-y-15 w-full px-[5%] sm:px-15 pt-15">
        ...
        <div className="flex flex-col w-full sm:w-[80%] mx-auto gap-y-5 px-5">
          ...
          <p className="text-paragraph text-sm max-w-[80%] sm:max-w-[60%]">Stay informed on feature releases, product roadmap, support, and cloud offerings!</p>

          <div className="flex gap-x-5 text-paragraph items-center sm:items-start">
      ...
      <div className="w-full">
        <div className="flex flex-col sm:flex-row justify-between w-full h-[10%] text-xs sm:text-sm bg-gray-50 p-5 sm:p-15 gap-y-2">
          <div className="text-paragraph"> © 2026 Tutor Victory, All Rights Reserved. </div>
          <div className="text-paragraph flex gap-x-2 sm:gap-x-5">
            <Link href="/cancellation-policy" className="hover:underline hover:cursor-pointer">Cancellation Policy</Link>
            <span className="block px-1 sm:hidden">|</span>
