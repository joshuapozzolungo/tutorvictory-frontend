  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-[#EFEAFF]">
      <div className="w-[40%] max-w-md">
        ...
        <div className="bg-white rounded-md px-10 py-10 flex flex-col gap-y-5">
        ...
        <p className="text-center text-sm fold-medium pt-5 ">Don't have an account yet? 
          <a className="pl-1 text-call-to-action font-bold hover:underline hover:cursor-pointer">Register</a>
        </p>
      </div>
    </div>
  )
